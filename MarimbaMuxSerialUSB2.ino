...
byte Note[2][16] = {
  /* _ Hihat tip
    ...
    |    |   |   |   |   |   |   |   |   |   |   |   |   |  |    _ Ride bell
    |    |   |   |   |   |   |   |   |   |   |   |   |   |  |   |       BANK */
  { 74 + oct, 73 + oct, 72 + oct, 71 + oct, 70 + oct, 69 + oct, 68 + oct, 67 + oct, 66 + oct, 65 + oct, 64 + oct,
  63 + oct, 62 + oct, 61 + oct, 60 + oct, 59 + oct},
  { 76 + oct, 75 + oct, 88 + oct, 87 + oct, 86 + oct, 85 + oct, 84 + oct, 83 + oct, 82 + oct, 81 + oct, 80 + oct,
  79 + oct, 78 + oct, 77 + oct, 76 + oct, 77 + oct}
};
...
HelloDrum pad29(28);
HelloDrum pad30(29);
HelloDrum pad31(17); //14
HelloDrum pad32(16); //15
...
void loop()
{
  ...
  if (pad1.hit == true && pos[0] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD1[4], 0, 1);
    usbMIDI.sendNoteOn(PAD1[4], pad1.velocity, 1); //(note, velocity, channel)
  ...
  if (pad2.hit == true && pos[1] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD2[4], 0, 1);
    usbMIDI.sendNoteOn(PAD2[4], pad2.velocity, 1); //(note, velocity, channel)
  ...
  if (pad3.hit == true && pos[2] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD3[4], 0, 1);
    usbMIDI.sendNoteOn(PAD3[4], pad3.velocity, 1); //(note, velocity, channel)
  ...
  if (pad4.hit == true && pos[3] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD4[4], 0, 1);
    usbMIDI.sendNoteOn(PAD4[4], pad4.velocity, 1); //(note, velocity, channel)
  ...
  if (pad5.hit == true && pos[4] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD5[4], 0, 1);
    usbMIDI.sendNoteOn(PAD5[4], pad5.velocity, 1); //(note, velocity, channel)
  ...
  if (pad6.hit == true && pos[5] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD6[4], 0, 1);
    usbMIDI.sendNoteOn(PAD6[4], pad6.velocity, 1); //(note, velocity, channel)
  ...
  if (pad7.hit == true && pos[6] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD7[4], 0, 1);
    usbMIDI.sendNoteOn(PAD7[4], pad7.velocity, 1); //(note, velocity, channel)
  ...
  if (pad8.hit == true && pos[7] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD8[4], 0, 1);
    usbMIDI.sendNoteOn(PAD8[4], pad8.velocity, 1); //(note, velocity, channel)
  ...
  if (pad9.hit == true && pos[8] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD9[4], 0, 1);
    usbMIDI.sendNoteOn(PAD9[4], pad9.velocity, 1); //(note, velocity, channel)
  ...
  if (pad10.hit == true && pos[9] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD10[4], 0, 1);
    usbMIDI.sendNoteOn(PAD10[4], pad10.velocity, 1); //(note, velocity, channel)
  ...
  if (pad11.hit == true && pos[10] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD11[4], 0, 1);
    usbMIDI.sendNoteOn(PAD11[4], pad11.velocity, 1); //(note, velocity, channel)
  ...
  if (pad12.hit == true && pos[11] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD12[4], 0, 1);
    usbMIDI.sendNoteOn(PAD12[4], pad12.velocity, 1); //(note, velocity, channel)
  ...
  if (pad13.hit == true && pos[12] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD13[4], 0, 1);
    usbMIDI.sendNoteOn(PAD13[4], pad13.velocity, 1); //(note, velocity, channel)
  ...
  if (pad14.hit == true && pos[13] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD14[4], 0, 1);
    usbMIDI.sendNoteOn(PAD14[4], pad14.velocity, 1); //(note, velocity, channel)
  ...
  if (pad15.hit == true && pos[14] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD15[4], 0, 1);
    usbMIDI.sendNoteOn(PAD15[4], pad15.velocity, 1); //(note, velocity, channel)
  ...
  if (pad16.hit == true && pos[15] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD16[4], 0, 1);
    usbMIDI.sendNoteOn(PAD16[4], pad16.velocity, 1); //(note, velocity, channel)
  ...
  if (pad17.hit == true && pos[16] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD17[4], 0, 1);
    usbMIDI.sendNoteOn(PAD17[4], pad17.velocity, 1); //(note, velocity, channel)
  ...
  if (pad18.hit == true && pos[17] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD18[4], 0, 1);
    usbMIDI.sendNoteOn(PAD18[4], pad18.velocity, 1); //(note, velocity, channel)
  ...
  if (pad19.hit == true && pos[18] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD19[4], 0, 1);
    usbMIDI.sendNoteOn(PAD19[4], pad19.velocity, 1); //(note, velocity, channel)
  ...
  if (pad20.hit == true && pos[19] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD20[4], 0, 1);
    usbMIDI.sendNoteOn(PAD20[4], pad20.velocity, 1); //(note, velocity, channel)
  ...
  if (pad21.hit == true && pos[20] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD21[4], 0, 1);
    usbMIDI.sendNoteOn(PAD21[4], pad21.velocity, 1); //(note, velocity, channel)
  ...
  if (pad22.hit == true && pos[21] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD22[4], 0, 1);
    usbMIDI.sendNoteOn(PAD22[4], pad22.velocity, 1); //(note, velocity, channel)
  ...
  if (pad23.hit == true && pos[22] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD23[4], 0, 1);
    usbMIDI.sendNoteOn(PAD23[4], pad23.velocity, 1); //(note, velocity, channel)
  ...
  if (pad24.hit == true && pos[23] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD24[4], 0, 1);
    usbMIDI.sendNoteOn(PAD24[4], pad24.velocity, 1); //(note, velocity, channel)
  ...
  if (pad25.hit == true && pos[24] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD25[4], 0, 1);
    usbMIDI.sendNoteOn(PAD25[4], pad25.velocity, 1); //(note, velocity, channel)
  ...
  if (pad26.hit == true && pos[25] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD26[4], 0, 1);
    usbMIDI.sendNoteOn(PAD26[4], pad26.velocity, 1); //(note, velocity, channel)
  ...
  if (pad27.hit == true && pos[26] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD27[4], 0, 1);
    usbMIDI.sendNoteOn(PAD27[4], pad27.velocity, 1); //(note, velocity, channel)
  ...
  if (pad28.hit == true && pos[27] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD28[4], 0, 1);
    usbMIDI.sendNoteOn(PAD28[4], pad28.velocity, 1); //(note, velocity, channel)
  ...
  if (pad29.hit == true && pos[28] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD29[4], 0, 1);
    usbMIDI.sendNoteOn(PAD29[4], pad29.velocity, 1); //(note, velocity, channel)
  ...
  if (pad30.hit == true && pos[29] == 1)
  {
    ...
    usbMIDI.sendNoteOn(PAD30[4], 0, 1);
    usbMIDI.sendNoteOn(PAD30[4], pad30.velocity, 1); //(note, velocity, channel)
  ...
  for (int i = 0; i < 30; i++) {
    if (countdown[i] > 1) {
      ...
      if (i >= 16) {
        ...
        usbMIDI.sendNoteOn(Note[1][i - 16], 0, 1);
      } else {
        MIDI.sendNoteOn(Note[0][i], 0, 1);
        usbMIDI.sendNoteOn(Note[0][i], 0, 1);
      }
      pos[i] = 0;
    }
  }
  ...
  */
  ...
  for (int i = 0; i < 2; i++) {
    ...
    potposnow[i] = map(potvalue[i], 1023, 0, 4, 1); // Para 4 posiciones, por ejemplo.
